...
CREATE TABLE USUARIO_PLANTILLA_ACCESO (
    ...
    PUEDE_DISENIAR           NUMBER(1) DEFAULT 0,
...
INSERT INTO DECLARACION_ADJUNTO (CODIGO_FORMULARIO_DECLARACION, NOMBRE_ORIGINAL, NOMBRE_ALMACENADO, RUTA_ALMACENAMIENTO, MIME_TYPE, TAMANIO_BYTES, HASH_SHA256, USUARIO_CARGA) VALUES
(
    (SELECT CODIGO FROM FORMULARIO_DECLARACION WHERE RUC_CONTRIBUYENTE = '1790012345001' AND PERIODO_FISCAL = '2026-01'),
